	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 appendResult9 = (float2(tex2DNode4.r , 0.0));
				float2 appendResult27 = (float2(IN.color.r , IN.color.g));
				float4 tex2DNode5 = tex2D( _gradient, ( appendResult9 + (float2( -1,-1 ) + (appendResult27 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) );
				float4 appendResult10 = (float4(tex2DNode5.r , tex2DNode5.g , tex2DNode5.b , tex2DNode4.a));
				
				fixed4 c = ( appendResult10 * _Color );
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
Node;AmplifyShaderEditor.DynamicAppendNode;27;-1876.691,240.2403;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;9;-1605.454,-41.3774;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TFHCRemapNode;28;-1676.691,248.2403;Float;False;5;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT2;1,1;False;3;FLOAT2;-1,-1;False;4;FLOAT2;1,1;False;1;FLOAT2;0
