	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 appendResult9 = (float2(tex2DNode4.r , 0.5));
				float4 tex2DNode5 = tex2D( _gradient, appendResult9 );
				float4 appendResult10 = (float4(tex2DNode5.r , tex2DNode5.g , tex2DNode5.b , tex2DNode4.a));
				
				fixed4 c = ( appendResult10 * _Color * IN.color );
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;24;-1258.551,181.7817;Float;False;0;0;_Color;Shader;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;25;-1243.966,347.8548;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-669.3937,72.75295;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
